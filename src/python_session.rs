...
#[cfg(target_family = "unix")]
pub(crate) fn begin_turn(turn_id: u64, input: String) {
    let payload = normalize_pty_turn_payload(prepare_worker_stdin_payload(&input));
    begin_or_append_turn_input(turn_id, payload);
}

#[cfg(not(target_family = "unix"))]
pub(crate) fn begin_turn(_turn_id: u64, _input: String) {}

#[cfg(target_family = "unix")]
pub(crate) fn append_turn_input(turn_id: u64, input: String) {
    let payload = normalize_pty_turn_payload(prepare_worker_stdin_payload(&input));
    begin_or_append_turn_input(turn_id, payload);
}

#[cfg(not(target_family = "unix"))]
pub(crate) fn append_turn_input(_turn_id: u64, _input: String) {}
