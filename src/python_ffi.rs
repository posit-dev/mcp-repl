...
pub struct PythonApi {
    ...
    pub py_eval_restore_thread: unsafe extern "C" fn(*mut PyThreadState),
    pub py_finalize_ex: unsafe extern "C" fn() -> c_int,
...
impl PythonApi {
    ...
    unsafe fn load(lib_path: &Path) -> Result<Self, String> {
        ...
        let api = Self {
            ...
            py_eval_restore_thread: unsafe { load_symbol(&library, b"PyEval_RestoreThread\0")? },
            py_finalize_ex: unsafe { load_symbol(&library, b"Py_FinalizeEx\0")? },
