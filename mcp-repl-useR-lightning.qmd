...
draw_person <- function(x, y, border) {
  ...
  draw_arrow <- function(x0, y0, x1, y1, col) {
  arrows(x0, y0, x1, y1, length = 0.11, angle = 24, code = 3, col = col, lwd = 2.8)
}
...
draw_arrow(12.3, 31, 17.6, 31, blue)
draw_arrow(32.4, 31, 36.6, 31, blue)
...
draw_arrow(65.2, 39, 75.5, 40, green)
draw_arrow(84, 35.2, 79.5, 28, green)
draw_arrow(63.8, 36.4, 70.2, 27.9, green)
text(
  75,
  13,
  "Human, agent, and REPL remain connected.",
