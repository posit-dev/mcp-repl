...
draw_arrow_between <- function(x0, y0, x1, y1, col, start_gap, end_gap) {
  dx <- x1 - x0
  dy <- y1 - y0
  distance <- sqrt(dx^2 + dy^2)
  stopifnot(distance > 0)
  draw_arrow(
    x0 + start_gap * dx / distance,
    y0 + start_gap * dy / distance,
    x1 - end_gap * dx / distance,
    y1 - end_gap * dy / distance,
    col
  )
}
