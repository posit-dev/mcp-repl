...
- `docs/futurework/worker-pty-stdin-transport.md`: deferred note on pre-launch pipe versus PTY stdin transport selection for workers that need TTY-like input.
