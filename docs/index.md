...
- `docs/futurework/rscript-backed-plot-reference-tests.md`: future direction for validating R plot images against `Rscript` renders instead of snapshotting image content.
