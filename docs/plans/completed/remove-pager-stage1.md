...
- Preserve sideband ordering metadata so later stages can make richer timeline decisions without changing visible behavior in this stage.
...
- Preserve runtime output verbatim in this stage and avoid synthesized input summaries.
