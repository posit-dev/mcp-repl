...
- Control prefixes in `input`: `\u0003` (interrupt) and `\u0004` (Ctrl-D / EOF restart, return output captured during the bounded restart shutdown window, then run remaining input under the original call timeout).
